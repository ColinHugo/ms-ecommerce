package com.hcolin.ecommerce.email;

import com.hcolin.ecommerce.kafka.order.Product;
...
import static com.hcolin.ecommerce.email.EmailTemplates.ORDER_CONFIRMATION;
import static com.hcolin.ecommerce.email.EmailTemplates.PAYMENT_CONFIRMATION;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail( String destinationEmail, String customerName, BigDecimal amount, String orderReference ) throws MessagingException {
        ...
        messageHelper.setFrom( "contact@hcolincoding.com" );
